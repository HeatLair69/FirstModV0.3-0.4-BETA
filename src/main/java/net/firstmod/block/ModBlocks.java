...
public class ModBlocks {
    ...
    public static final Block OP_BLOCK = registerBlock("op_block", new OpBlock(FabricBlockSettings.copyOf(Blocks.NETHERITE_BLOCK).strength(5.0f, 6.0f))); // Update this line
