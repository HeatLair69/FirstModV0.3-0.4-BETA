package net.firstmod.entity.custom;

import net.firstmod.entity.ModEntities;
import net.firstmod.entity.ai.PorcupineAttackGoal;
...
public class PorcupineEntity extends AnimalEntity {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(2, new TemptGoal(this, 1.25D, Ingredient.ofItems(Items.GRASS), false));
